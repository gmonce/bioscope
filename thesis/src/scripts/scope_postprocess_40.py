...
def apply_morante2009_rules(sentence):
	...
	if total_F==0 and total_L==1:
		...
		#elif passive_voice=='Y' and hay_nexts:
		elif hay_nexts:
			print sentence[0][1],":Regla passive voice"
	...
	# Corregido en la corrida 40: pongo el parent, que es el caso más probable en el training corpus
	...
	if pos_hc=='JJ' and lemma_hc=='likely' and (sentence[hc_pos-1][10]=='be' or sentence[hc_pos-2][10]=='be') and hay_nexts:
	...
	if sentence[0][1]=='S704.2':
		print sentence[first][10], sentence[last][10]
