...
def apply_morante2009_rules(sentence):
	...
	if lemma_hc=='likely':
		print sentence[0][1],pos_hc, lemma_hc, sentence[hc_pos-1][10], sentence[hc_pos-2][10]
	if pos_hc=='JJ' and lemma_hc=='likely' and (sentence[hc_pos-1][10]=='be' or sentence[hc_pos-2][10]=='be'):
		print sentence[0][1],":Regla is likely" 
		first=nexts_scope_start
		last=nexts_scope_end
		print (first,last)
