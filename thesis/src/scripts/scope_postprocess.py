...
def apply_morante2009_rules(sentence):
	...
	if runx>46 and POS_hc=='MD' and passive_voice=='Y' and hay_nexts:
		#print sentence[0][1],":Regla x1"
	...
	if runx>46 and POS_hc=='VBN' and sentence[hc_pos-1][7]=='be' and hay_nexts:
		#print sentence[0][1],":Regla x2" 
		first=nexts_scope_start
		last=nexts_scope_end
		
	# Regla x3: si a la izquierda del scope hay un which, lo incluyo
	# Agregado en la corrida 36
	if runx>46  and sentence[first-1][7] == 'which' and passive_voice=='Y':
		#print sentence[0][1],":Regla x3" 
		first=first-1
	
	# Regla x4: si es is likely/JJ, entonces tomo el enclosing S
	# Agregado en la corrida 38
	# Para corregir errores S461.5 y S467.7
	if runx>46 and POS_hc=='JJ' and lemma_hc=='likely' and (sentence[hc_pos-1][7]=='be' or sentence[hc_pos-2][7]=='be') and hay_nexts:
		#print sentence[0][1],":regla x4"
		first=nexts_scope_start
		last=nexts_scope_end
	...
	if runx>46 and sentence[last][7]==')':
		#print sentence[0][1],":regla x5"
