...
def apply_morante2009_rules(sentence):
	...
	if total_F==0 and total_L==1:
		if runx>45 and hc_parent_pos=='ADJP' and hc_gparent_pos=='VP' and hc_ggparent_scope_end==first_L:
			first=hc_ggparent_scope_start
		elif runx>45 and hay_nexts:
			first=nexts_scope_start			
			last=nexts_scope_end			
		# Si hay voz pasiva, elijo preferentemente al bisabuelo en vez de al abuelo			
		elif runx>45 and pos_hc=='VBN' and hc_ggparent_scope_end==first_L:
			first=hc_ggparent_scope_start		
		elif runx>45 and hc_gparent_scope_end==first_L:
			first=hc_gparent_scope_start
		elif runx>45 and hc_parent_scope_end==first_L:
			first=hc_parent_scope_start
		elif runx>45 and hc_ggparent_scope_end==first_L:
			first=hc_ggparent_scope_start
		else:
	...
	if runx>16 and Y_pos<>-1 and hc_gparent_scope_end<>-1:
